...
const Card = (props) => {
  const {name, login, avatar_url, html_url, location, blog, company, created_at, twitter_username, bio, public_repos, followers, following} = props.userOther
    ...
    <div className='card-container mt-3 w-100'>
      ...
      <div className="card-infos d-flex justify-content-center gap-5 my-4">
        <div className="card-infos__item">
          <span>Depolar</span>
          <span>{public_repos ? public_repos : "12"}</span>
        </div>
